...
func GetClosestDirection(vector: Vector2) -> int:
...
func SetDirection() -> bool:
	...
	cardinal_direction = directions[GetClosestDirection(look_dir)]
	return old_dir != cardinal_direction

func UpdateAnimation(state: String) -> void:
	var animation_name: String = state + "_" + AnimDirection(look_dir)
	#print("[UpdateAnimation]: " + animation_name)
	animation_player.play(animation_name)

func AnimDirection(vector: Vector2) -> String:
	var closest_index: int = GetClosestDirection(vector)
